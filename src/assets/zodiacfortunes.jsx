const zodiacFortunes = {
  rat: [
    ...
    `\nBest Months to Clean Your Home: January, February, April, August, November, December`,
  ],
  ox: [
    ...
    `\nBest Months to Clean Your Home: January, May, March, September, December`,
  ],
  tiger: [
    ...
    `\nBest Months to Clean Your Home: March, April, June, October, November`,
  ],
  rabbit: [
    ...
    `\nBest Months to Clean Your Home: February, April, July, August, October`,
  ],
  dragon: [
    ...
    `\nBest Months to Clean Your Home: February, April, August, September, December`,
  ],
  snake: [
    ...
    `\nBest Months to Clean Your Home: January, June, July, September, December`,
  ],
  horse: [
    ...
    `\nBest Months to Clean Your Home: February, April, May, July, October`,
  ],
  goat: [
    ...
    `\n\nLucky Animal Friend: Horse`,
    `\nBest Months to Clean Your Home: March, May, June, September, November`,
  ],
  monkey: [
    ...
    `\nBest Months to Clean Your Home: April, May, August, September, October, December`,
  ],
  rooster: [
    ...
    `\n\nLucky Animal Friend: Dog`,
    `\nBest Months to Clean Your Home: April, May, August, October, November`,
  ],
  dog: [
    ...
    `\nBest Months to Clean Your Home: February, May, August, October, November`,
  ],
  pig: [
    ...
    `\n\nLucky Animal Friend: Monkey`,
    `\nBest Months to Clean Your Home: January, May, September, November, December`,
  ],
};
